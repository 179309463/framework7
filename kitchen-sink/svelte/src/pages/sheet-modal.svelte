<Page onPageBeforeOut={onPageBeforeOut} onPageBeforeRemove={onPageBeforeRemove}>
  ...
  <Sheet
    ...
    backdrop
  >
    <div class="swipe-handler" onClick={() => toggleSwipeStep()}></div>
...
<script>
  import { f7, Page, Navbar, Sheet, PageContent, Toolbar, BlockTitle, Block, Button, Link, Row, List, ListItem } from 'framework7-svelte';
