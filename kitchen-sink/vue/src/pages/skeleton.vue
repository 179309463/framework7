<template>
  <f7-page>
    <f7-navbar title="Skeleton Layouts" back-link="返回"></f7-navbar>
    <f7-block strong>
...
<script>
  import { f7Page, f7Navbar, f7BlockTitle, f7Block, f7List, f7ListItem, f7Button, f7Row, f7SkeletonBlock, f7Card } from 'framework7-vue';
